...
//var MongoClient = require('mongodb').MongoClient,
    //test = require('assert');
//var url = 'mongodb://localhost:27017/passportdb';
//Connect using MongoClient
//MongoClient.connect(url, function(err, db) {
    //var db = db.db('passportdb'); //use can chose the database here
    //db.close();
//});
...
app.post('/signup',function(req,res)
  {
    ...
    //to calcute userl
    var userlength=mongoose.collection('users').find({}, {id:1,_id:0}).sort({id:-1}).limit(1);
